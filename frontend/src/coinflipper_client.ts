...
export class CoinFlipper extends bkr.ApplicationClient {
    desc: string = "";
    override appSchema: bkr.Schema = { declared: { beacon_app_id: { type: bkr.AVMType.uint64, key: "beacon_app_id", desc: "", static: false }, bets_outstanding: { type: bkr.AVMType.uint64, key: "bets_outstanding", desc: "", static: false }, max_bet: { type: bkr.AVMType.uint64, key: "max_bet", desc: "", static: false }, min_bet: { type: bkr.AVMType.uint64, key: "min_bet", desc: "", static: false } }, reserved: {} };
    override acctSchema: bkr.Schema = { declared: { bet: { type: bkr.AVMType.uint64, key: "bet", desc: "", static: false }, commitment_round: { type: bkr.AVMType.uint64, key: "commitment_round", desc: "", static: false }, heads: { type: bkr.AVMType.uint64, key: "heads", desc: "", static: false } }, reserved: {} };
